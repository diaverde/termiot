...
jQuery.get("data21.csv", undefined, process_data, "text");
jQuery.get("data22.csv", undefined, process_data, "text");
jQuery.get("data23.csv", undefined, process_data, "text");
jQuery.get("data24.csv", undefined, process_data, "text");
jQuery.get("data25.csv", undefined, process_data, "text");
jQuery.get("data26.csv", undefined, process_data, "text");
jQuery.get("data27.csv", undefined, process_data, "text");
jQuery.get("data28.csv", undefined, process_data, "text");
jQuery.get("data29.csv", undefined, process_data, "text");
jQuery.get("data30.csv", undefined, process_data, "text");
