...
jQuery.get("data31.csv", undefined, process_data, "text");
jQuery.get("data32.csv", undefined, process_data, "text");
jQuery.get("data33.csv", undefined, process_data, "text");
jQuery.get("data34.csv", undefined, process_data, "text");
jQuery.get("data35.csv", undefined, process_data, "text");
jQuery.get("data36.csv", undefined, process_data, "text");
jQuery.get("data37.csv", undefined, process_data, "text");
jQuery.get("data38.csv", undefined, process_data, "text");
jQuery.get("data39.csv", undefined, process_data, "text");
jQuery.get("data40.csv", undefined, process_data, "text");
