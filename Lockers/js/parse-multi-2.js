...
jQuery.get("data11.csv", undefined, process_data, "text");
jQuery.get("data12.csv", undefined, process_data, "text");
jQuery.get("data13.csv", undefined, process_data, "text");
jQuery.get("data14.csv", undefined, process_data, "text");
jQuery.get("data15.csv", undefined, process_data, "text");
jQuery.get("data16.csv", undefined, process_data, "text");
jQuery.get("data17.csv", undefined, process_data, "text");
jQuery.get("data88.csv", undefined, process_data, "text");
jQuery.get("data19.csv", undefined, process_data, "text");
jQuery.get("data20.csv", undefined, process_data, "text");
